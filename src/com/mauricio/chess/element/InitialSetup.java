...
public class InitialSetup {
    ...
    static {
        ...
        setup.get(PieceColor.WHITE).put(PieceType.Pawn, Arrays.asList("a2", "b2", "c2", "d2", "e2", "f2", "g2", "h2"));
        ...
        setup.get(PieceColor.BLACK).put(PieceType.Pawn, Arrays.asList("a7", "b7", "c7", "d7", "e7", "f7", "g7", "h7"));
